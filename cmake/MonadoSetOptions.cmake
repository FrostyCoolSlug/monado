...
#
# ``KEEP_SET``
#   List of option sets to leave unchanged (don't force to OFF).
#   Useful for large groups of options that auto-detect or have
#   good defaults.
#
#   Currently available sets are:
#   - OPENXR_FEATURES: covers XRT_FEATURE_OPENXR_* (but not XRT_FEATURE_OPENXR itself)
#   - DRIVERS: covers XRT_BUILD_DRIVER_*
#
#   If an option is included in a set and in ENABLE, it is treated as ENABLE.
#
...
function(monado_set_options)
	set(options "")
	set(oneValueArgs "")
	set(multiValueArgs ENABLE KEEP KEEP_SET)
	...
	set(
		...
		XRT_FEATURE_OPENXR_INTERACTION_CONTACTGLOVE2
		...
		XRT_FEATURE_OPENXR_INVERTED_ALPHA
		...
		XRT_FEATURE_OPENXR_VARJO_QUAD_VIEWS
	...
	set(
		...
		XRT_MODULE_OPENVR_STATE_TRACKER
		...
		XRT_FEATURE_NO_COMPOSITOR_FOR_HEADLESS_SESSIONS
		XRT_FEATURE_OPENVR
		XRT_FEATURE_OPENXR
	...
	foreach(_set ${MSO_KEEP_SET})
	  if(_set STREQUAL "OPENXR_FEATURES")
